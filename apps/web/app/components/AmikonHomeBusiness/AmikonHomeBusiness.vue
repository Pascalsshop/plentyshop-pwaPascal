...
const copies = {
  ...
  fr: {
    section: 'Rachat, entreprise et marques',
    purchase: 'Proposer du matériel',
    purchaseText: 'Nous achetons vos machines et pièces détachées d’occasion.',
    purchaseAlt: 'Équipements industriels d’occasion dans l’entrepôt Amikon',
    companySection: 'En savoir plus sur Amikon',
    companyText: 'Découvrez nos domaines d’activité sur notre site consacré au rachat.',
    companyAlt: 'Le site de l’entreprise Amikon affiché sur un écran',
    marketing: 'Commercialisation',
    marketingText: 'Nous vous conseillons pour la commercialisation de vos machines.',
    marketingAlt: 'Commercialisation de machines industrielles par Amikon',
    chooseSlide: 'Choisir une présentation de l’entreprise',
    brands: 'Une sélection des grandes marques de notre assortiment',
    searchBrand: 'Rechercher des produits de',
  },
  nl: {
    section: 'Inkoop, bedrijf en merken',
    purchase: 'Inkoopformulier',
    purchaseText: 'Wij kopen uw gebruikte machines en reserveonderdelen.',
    purchaseAlt: 'Gebruikte industriële apparatuur in het Amikon-magazijn',
    companySection: 'Meer over Amikon',
    companyText: 'Lees op onze inkoopwebsite op welke gebieden Amikon actief is.',
    companyAlt: 'De bedrijfswebsite van Amikon op een scherm',
    marketing: 'Verkoopbemiddeling',
    marketingText: 'Wij adviseren u bij de verkoop van uw machine.',
    marketingAlt: 'Verkoop van industriële machines door Amikon',
    chooseSlide: 'Bedrijfsinformatie kiezen',
    brands: 'Een selectie van topmerken uit ons assortiment',
    searchBrand: 'Zoek producten van',
  },
};
const copy = computed(() => copies[locale.value.toLowerCase().split('-')[0] as keyof typeof copies] ?? copies.en);
